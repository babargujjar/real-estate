...
const RentPropertyDetail = ({ property }) => {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
                 <div className='inline-block px-4 py-1 text-sm font-semibold rounded-full mb-4 bg-brand-primary text-brand-dark'>
                    For Rent
                </div>
            ...
            <div className="lg:sticky top-28 h-fit">
                 <div className="bg-brand-light-dark/70 rounded-2xl p-8 border border-gray-700 shadow-2xl shadow-black/30">
                    <p className="text-gray-400 text-lg">Rent</p>
                     <p className="text-4xl font-bold text-brand-primary mt-1">
                        {formattedPrice}
                        <span className="text-xl font-normal text-gray-400"> / year</span>
                    </p>
